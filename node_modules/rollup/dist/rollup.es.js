...
class LocalVariable extends Variable {
    constructor(name, declarator, init, context) {
        ...
        this.hasInitBeenForceIncluded = false;
...
const INCLUDE_VARIABLES = 'variables';
    ...
    includeCallArguments(args) {
        ...
        for (let index = args.length - 1; index >= 0; index--) {
            ...
            if (argIncluded) {
                ...
                if (hasInitBeenForceIncluded && arg instanceof Identifier$1 && arg.variable) {
...
class CallExpression$1 extends NodeBase {
    ...
    include(includeChildrenRecursively) {
        if (includeChildrenRecursively) {
            super.include(includeChildrenRecursively);
            if (includeChildrenRecursively === INCLUDE_VARIABLES &&
...
class TryStatement extends NodeBase {
    ...
    include(includeChildrenRecursively) {
        if (!this.directlyIncluded || !this.context.tryCatchDeoptimization) {
            ...
            this.block.include(this.context.tryCatchDeoptimization ? INCLUDE_VARIABLES : includeChildrenRecursively);
        }
